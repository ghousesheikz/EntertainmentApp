...
import com.entertainmentapp.Locationtracker.location.LocationManagerInterface;
import com.entertainmentapp.Locationtracker.location.SmartLocationManager;
import com.entertainmentapp.Locationtracker.permission.PermissionManager;
import com.entertainmentapp.Locationtracker.permission.PermissionManagerInterface;
...
public class BaseActivityLocation extends BaseActivity implements LocationManagerInterface {
    ...
    protected void onStart() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            manager.requestPermission(new String[]{Manifest.permission.ACCESS_FINE_LOCATION,Manifest.permission.ACCESS_COARSE_LOCATION});
        }
