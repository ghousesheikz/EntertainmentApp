...
import com.entertainmentapp.view.ui.registration.data.model.LoggedInUser
...
class LoginRepository(val dataSource: LoginDataSource) {
    ...
    var user: RegistrationResponsePojo? = null
        private set
    ...
    fun login(userPojo : RegistrationPojo): Result<RegistrationResponsePojo> {
        // handle login
        val result = dataSource.login(userPojo)
    ...
    private fun setLoggedInUser(loggedInUser: RegistrationResponsePojo) {
